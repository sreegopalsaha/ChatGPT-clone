...
const apiKey = 'Enter your apiKey'; //Example:sk-q0wDUqKAhsgwddUykiXDT3BlbkFJT2vJw9ee06VZesdfH3uQut
const apiUrl = 'https://api.openai.com/v1/chat/completions';
const database = `Always try to answer in less than 150 charecter.
                \n You are an AI made by SREE GOPAL SAHA.
                \n if someone say Hi or hello say Namaste! I am an AI made by Sree Gopal Saha, How may I assist you today?.
                `;
...
const Historybase = `Generate a short summary within 20 characters that summarizes the input.
                    ...
                    \n Input: "Where should I go for a trip?"
                       Response: "Tour Guide"
                    \nInput: "Write me a Twitter thread."
                     Response: "Twitter Thread Writing"
                    \nInput: "Tell me how TDM works."
                    Response: "TDM Workings"
                    \nInput: "Who is Sree Gopal Saha?"
                       Response: "Information about my Creator"
                       `;
...
//_________________________________________________
    ...
    aiRep.innerHTML = `<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/ChatGPT-Logo.svg/768px-ChatGPT-Logo.svg.png" alt="ChatGPT icon" class="ai-icon user-icon">
